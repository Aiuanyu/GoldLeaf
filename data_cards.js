cards = [
  ...
  [
    "化石",
    "<span class='si'>fasag</span><br><span class='hl'>fǎshàg</span>",
    "",
    "1"
  ],
  [
    "恐龍",
    "<span class='si'>kiùngliǔng</span><br><span class='hl'><ruby><rb>kiúng</rb><rp>(</rp><rt>kiūng</rt><rp>)</rp></ruby>liung</span>",
    "（標示變調：海陸腔 24 調前字一律變 33）",
    "1",
    "80"
  ],
  [
    "薑嫲園",
    "<span class='si'>gióngmǎ'iěn</span><br><span class='hl'>giòngmarhan</span>",
    "「薑嫲」即「薑」，客語這個詞似乎必加「-嫲」詞尾，所以不單稱「薑」。<br><br>苗栗縣大湖、銅鑼、三義 3 鄉交界處山嶺地名「薑麻園/羌麻園」，其實語源就是「<b>薑嫲園 gióngmǎ'iěn</b>」（種薑的園地），完全只跟薑有關，與麻無關。（該地為四縣腔區）所以那裡真的就是盛產薑以及相關製品，餐廳簡餐還有薑黃飯 😆～",
    "1",
    "72"
  ],
  [
    "油桐花",
    "<span class='si'>iǔtǔngfá</span><br><span class='hl'>rhiutungfà</span>",
    "",
    "1",
    "80"
  ],
  [
    "[ˈslaʋɐ ʊkrɐˈjinʲi]",
    "<ruby><rb>Слава Україні!</rb><rp>(</rp><rt>Sláva Ukrayíni!</rt><rp>)</rp></ruby>",
    "「榮光歸烏克蘭！」",
    "4",
    "65"
  ],
  ...
  [
    "割包",
    "kuah-pau",
    "臺灣鶴佬族傳統小吃美食，又名「hóo-kā-ti 虎咬豬」。<br>Kuah-pau 的發音可直接借入其他語言的語流中，例如華語可稱「ㄍㄨㄚˋㄅㄠ/guàbao」，至於漢字方面建議捨棄民間俗寫，回歸「割」字，如果真的要華語化就講「ㄍㄜ ㄅㄠ」吧<br>（那客語就是 gòdbáu/godbàu？😆）。",
    "2",
    "95"
  ],
  [
